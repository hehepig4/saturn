"""CQ-driven prompts for primitive column classes.

The classes provide a shared semantic vocabulary for column profiling and
query transformation. Table metadata can supply virtual columns. Classes
should cover query requirements while keeping the ontology compact.
"""
