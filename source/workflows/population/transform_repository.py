...
class TransformRepository:
    ...
    def find_best_contract(
        ...
        self._load_cache()
        # Hit/miss is reported to global cache stats so the paper can attribute
        # transform-reuse rate to the population/indexing phase.
        from llm.statistics import record_cache_hit, record_cache_miss
