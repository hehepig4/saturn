...
Examples:
  ...
  python source/cli/run_pipeline.py --total-queries 100 --agent-cq-capacity 30

  # Run with manual cluster count
  python source/cli/run_pipeline.py --n-clusters 5 --total-queries 200

  # Run full pipeline (all 5 stages)
  python source/cli/run_pipeline.py --step all --total-queries 100 --max-tables 50

  # Run Layer 2 pipeline using existing Layer 1
  python source/cli/run_pipeline.py --step layer2_all --max-tables 50

  # Only generate retrieval indexes
  python source/cli/run_pipeline.py --step retrieval_index

  # Multiple iterations for consensus
  python source/cli/run_pipeline.py --total-queries 100 --n-iterations 2
        """
    )
    parser.add_argument(
        "-d", "--dataset",
    ...
    elif args.step == "retrieval_index":
        logger.info("  Building indexes from table profiles")
